...
export const getData = async (slug, limit = null, lang = "en-US", page = null) => {
	const res = await fetch(`/api/${slug}?lang=${lang}${page && `&page=${page}`} `)
...
export const getMovie = async(id, lang = "en-US") => {
	const res = await fetch(`/api/get-movie?id=${id}&lang=${lang}`)
...
export const getVideo = async(id, lang = "en-US") => {
	const res = await fetch(`/api/get-video?id=${id}&lang=${lang}`)
...
export const getCredits = async(id, lang = "en-US") => {
	const res = await fetch(`/api/get-credits?id=${id}&lang=${lang}`)
...
export const getGenre = async(platform = 'movies', lang = "en-US") => {
	const res = await fetch(`/api/genres?platform=${platform}&lang=${lang}`)
